...
Structurelessness, then, is the cop-out of people who don't want to deal with creating structures,
or bring a naive kind of skepticism of any and all authority.
This doesn't mean you should put in place a dictator and count on them staying benevolent,
or make everything uber-rigid —
but you should make structures legible, so they can be navigated on equal footing by everyone while they are working, and deliberately criticized and changed when they no longer are.
