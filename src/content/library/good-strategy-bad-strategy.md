...
To which Rumelt would find a creative (and snarky) way of saying:
"NO!! BAD!!"

"Good Strategy", as he sees it, has to involve a "kernel" of at least three things instead:

1. A diagnosis of your current situation — what's the problem you're trying to solve and the reality you find yourself in?
2. A guiding policy for dealing with the situation — what's the general approach you want to take?
3. A set of coherent actions you're planning to take to implement that policy — who's going to do what?
